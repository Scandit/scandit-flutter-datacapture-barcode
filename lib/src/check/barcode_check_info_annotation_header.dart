...
class BarcodeCheckInfoAnnotationHeader extends Serializable with ChangeNotifier {
  String? _text = BarcodeCheckDefaults.view.defaultInfoAnnotationHeaderText;
  ...
  ScanditIcon? _icon = BarcodeCheckDefaults.view.defaultInfoAnnotationHeaderIcon;
  ...
  Color? _backgroundColor = BarcodeCheckDefaults.view.defaultInfoAnnotationHeaderBackgroundColor;
  ...
  Color? _textColor = BarcodeCheckDefaults.view.defaultInfoAnnotationHeaderTextColor;
  ...
  double _textSize = BarcodeCheckDefaults.view.defaultInfoAnnotationHeaderTextSize;
