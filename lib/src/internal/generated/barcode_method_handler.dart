...
class BarcodeMethodHandler {
  ...
  Future<String> generateFromBaseEncodedData(
      {required String generatorId, required String data, required int imageWidth}) async {
    final params = {
  ...
  Future<String> generateFromString(
      {required String generatorId, required String text, required int imageWidth}) async {
    final params = {
      'generatorId': generatorId,
      'text': text,
      'imageWidth': imageWidth,
  ...
  Future<Uint8List?> generateFromBaseEncodedDataToBytes(
      {required String generatorId, required Uint8List data, required int imageWidth}) async {
    final params = {
      'generatorId': generatorId,
      'data': data,
      'imageWidth': imageWidth,
  ...
  Future<void> setSelectBarcodeEnabled(
      {required int modeId, required String barcodeJson, required bool enabled}) async {
    final params = {
      'modeId': modeId,
  ...
  Future<num> getCountForBarcodeInBarcodeSelectionSession(
      {required int modeId, required String selectionIdentifier}) async {
    final params = {
      'modeId': modeId,
      'selectionIdentifier': selectionIdentifier,
    };
    final result =
        await executeBarcode('BarcodeSelectionModule', 'getCountForBarcodeInBarcodeSelectionSession', params);
  ...
  Future<void> setBrushForTrackedBarcode(
      {required int dataCaptureViewId, String? brushJson, required int trackedBarcodeIdentifier}) async {
    final params = {
  ...
  Future<void> setViewForTrackedBarcodeFromBytes(
      {required int dataCaptureViewId, Uint8List? viewBytes, required int trackedBarcodeIdentifier}) async {
    final params = {
      'dataCaptureViewId': dataCaptureViewId,
  ...
  Future<void> updateSizeOfTrackedBarcodeView(
      {required int trackedBarcodeIdentifier, required int width, required int height}) async {
    final params = {
      'trackedBarcodeIdentifier': trackedBarcodeIdentifier,
      'width': width,
      'height': height,
  ...
  Future<void> setAnchorForTrackedBarcode(
      {required int dataCaptureViewId, required String anchorJson, required int trackedBarcodeIdentifier}) async {
    final params = {
      'dataCaptureViewId': dataCaptureViewId,
  ...
  Future<void> setOffsetForTrackedBarcode(
      {required int dataCaptureViewId, required String offsetJson, required int trackedBarcodeIdentifier}) async {
    final params = {
      'dataCaptureViewId': dataCaptureViewId,
  ...
  Future<void> finishBarcodeCountBrushForRecognizedBarcode(
      {required int viewId, String? brushJson, required int trackedBarcodeId}) async {
    final params = {
      'viewId': viewId,
      if (brushJson != null) 'brushJson': brushJson,
  ...
  Future<void> setBarcodeCountCaptureList({required int viewId, required String captureListJson}) async {
    final params = {
      'viewId': viewId,
  ...
  Future<Map<String, dynamic>?> getBarcodeCountSpatialMapWithHints(
      {required int viewId, required int expectedNumberOfRows, required int expectedNumberOfColumns}) async {
    final params = {
      'viewId': viewId,
  ...
  Future<void> submitSparkScanFeedbackForBarcode({required int viewId, String? feedbackJson}) async {
    final params = {
      'viewId': viewId,
      if (feedbackJson != null) 'feedbackJson': feedbackJson,
    };
  ...
  Future<void> finishBarcodePickViewHighlightStyleCustomViewProviderViewForRequest(
      {required int viewId, required int requestId, Map<String, dynamic>? response}) async {
    final params = {
      'viewId': viewId,
      'requestId': requestId,
    ...
    return await executeBarcode(
        'BarcodePickModule', 'finishBarcodePickViewHighlightStyleCustomViewProviderViewForRequest', params);
  }
  ...
  Future<void> finishBarcodePickViewHighlightStyleAsyncProviderStyleForRequest(
      {required int viewId, required int requestId, String? responseJson}) async {
    final params = {
      'viewId': viewId,
      'requestId': requestId,
    ...
    return await executeBarcode(
        'BarcodePickModule', 'finishBarcodePickViewHighlightStyleAsyncProviderStyleForRequest', params);
  }
  ...
  Future<void> submitBarcodeFindTransformerResult({required int viewId, String? transformedBarcode}) async {
    final params = {
      'viewId': viewId,
      if (transformedBarcode != null) 'transformedBarcode': transformedBarcode,
    };
