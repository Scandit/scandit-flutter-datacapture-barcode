...
public class ScanditFlutterDataCaptureBarcode: NSObject, FlutterPlugin {
    ...
    public static func register(with registrar: FlutterPluginRegistrar) {
        ...
        let barcodeMethodChannel = FlutterMethodChannel(
        ...
        let barcodeCaptureMethodChannel = FlutterMethodChannel(
            name: "com.scandit.datacapture.barcode.capture/method_channel",
            binaryMessenger: registrar.messenger()
        )
        ...
        barcodeCaptureMethodChannel.setMethodCallHandler(
            barcodeCaptureMethodHandler.methodCallHandler(methodCall:result:)
        )
        ...
        let barcodeBatchMethodChannel = FlutterMethodChannel(
            name: "com.scandit.datacapture.barcode.batch/method_channel",
            binaryMessenger: registrar.messenger()
        )
        ...
        let barcodeSelectionMethodChannel = FlutterMethodChannel(
            name: "com.scandit.datacapture.barcode.selection/method_channel",
            binaryMessenger: registrar.messenger()
        )
        let barcodeSelectionMethodHandler = BarcodeSelectionMethodHandler(
            barcodeSelectionModule: barcodeSelectionModule
        )
        barcodeSelectionMethodChannel.setMethodCallHandler(
            barcodeSelectionMethodHandler.methodCallHandler(methodCall:result:)
        )
        ...
        let barcodeCountMethodChannel = FlutterMethodChannel(
            name: "com.scandit.datacapture.barcode.count/method_channel",
            binaryMessenger: registrar.messenger()
        )
        ...
        let sparkScanMethodChannel = FlutterMethodChannel(
            name: "com.scandit.datacapture.barcode.spark/method_channel",
            binaryMessenger: registrar.messenger()
        )
        ...
        let barcodeFindMethodChannel = FlutterMethodChannel(
            name: "com.scandit.datacapture.barcode.find/method_channel",
            binaryMessenger: registrar.messenger()
        )
        ...
        let barcdePickMethodChannel = FlutterMethodChannel(
            name: "com.scandit.datacapture.barcode.pick/method_channel",
            binaryMessenger: registrar.messenger()
        )
        ...
        let barcodeArMethodChannel = FlutterMethodChannel(
            name: "com.scandit.datacapture.barcode.ar/method_channel",
            binaryMessenger: registrar.messenger()
        )
        ...
        let barcodeGeneratorMethodChannel = FlutterMethodChannel(
            name: "com.scandit.datacapture.barcode.generator/method_channel",
            binaryMessenger: registrar.messenger()
        )
        let barcodeGeneratorMethodHandler = BarcodeGeneratorHandler(barcodeGeneratorModule: barcodeGeneratorModule)
        barcodeGeneratorMethodChannel.setMethodCallHandler(
            barcodeGeneratorMethodHandler.methodCallHandler(methodCall:result:)
        )
